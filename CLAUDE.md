...
| **P2: BatchProcessor 循环消费（逐日清空队列）** | 2026-03-29 | 待提交 |
| **P2: renameCategory 回归冻结口径（只改名不重分类）** | 2026-03-29 | 待提交 |
| **P2: 渐进式标签 UI（ReclassifyConfirmDialog + SettingsPage 改造）** | 2026-03-29 | 待提交 |
| **P2: 生命周期联动补全（classify_memory / classify_examples / memory_snapshots）** | 2026-03-29 | 待提交 |
| **P2: 切换账本自动 recoverPending + enqueue 空日期防御** | 2026-03-29 | 待提交 |
